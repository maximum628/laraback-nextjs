...
const TABLE_HEAD = [
  ...
  { id: 'store', label: 'Store', align: 'left' },
  ...
  { id: 'clicks', label: 'Clicks', align: 'center' },
...
OfferLists.getLayout = function getLayout(page) {
...
export default function OfferLists() {
  ...
  const [tableData, setTableData] = useState(_OfferLists);
      ...
      <Container maxWidth={themeStretch ? false : 'lg'}>
        <HeaderBreadcrumbs
          ...
          links={[
            ...
            { name: 'Offers', href: PATH_ADMIN.store_offers.stores },
          ]}
          action={
            <ThemeProvider theme={mytheme}>
              <Button variant="contained" color="blue" startIcon={<Iconify icon={'eva:plus-fill'} />}>
                Create New
              </Button>
              <Button variant="contained" color="red" startIcon={<Iconify icon={'eva:save-fill'} />}>
                import CSV
              </Button>
              <Button variant="contained" color="green" startIcon={<Iconify icon={'eva:monitor-outline'} />}>
                Bulk Edit
              </Button>
            </ThemeProvider>
          }
