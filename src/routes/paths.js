...
export const PATH_ADMIN = {
  ...
  store_offers: {
    stores: path(ROOTS_ADMIN, '/stores'),
    storecashback: path(ROOTS_ADMIN, '/storecashback'),
    storecategories: path(ROOTS_ADMIN, '/storecategories'),
    couponoffers: path(ROOTS_ADMIN, '/couponoffers'),
    offercategories: path(ROOTS_ADMIN, '/offercategories'),
    dailydeals: path(ROOTS_ADMIN, '/dailydeals'),
    dealscategories: path(ROOTS_ADMIN, '/dealscategories'),
  },
  instaback_promo: {
